  		...
  		//Evaluo el resultado
  			if ($resultado===true) {
  				//Realizo la actualizacion de la liquidacion
				    $sentencia="UPDATE corte SET importe_boletos_talonario=importe_boletos_talonario+$precio, cantidad_boletos_talonario=cantidad_boletos_talonario+1 where id=$id_liquidacion;";
				  //Ejecuto la sentencia
				    $resultado=ejecuta_sentencia_sistema($sentencia,TRUE);
