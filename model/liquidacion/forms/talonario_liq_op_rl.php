...
<script type="text/javascript">
  //Funcion para cargar el formulario de liquidacion especifico
    function muestra_talonario(opcion){
      ...
      var url="model/liquidacion/queries/liq_talonario_op_rl.php"
      $.ajax({
        type: "POST",
        url:url,
        data:{
  ...
  //Funcion para cargar el formulario de liquidacion especifico
    function tabla_talonario(opcion){
      var dato=<?php echo "'".$enviado."'"; ?>;
      var url="model/liquidacion/forms/tabla_talonario_liq_op_rl.php"
      $.ajax({
        type: "POST",
        url:url,
        data:{
...
<div class="card">
  <div class="card-text">
    <a onclick="tabla_talonario(<?php echo "'".$enviado."'"; ?>)" class="btn btn-primary btn-block" data-toggle="tooltip"><strong>VER TALONARIOS REGISTRADOS</strong></a>
  </div>
  <div class="card-body">
