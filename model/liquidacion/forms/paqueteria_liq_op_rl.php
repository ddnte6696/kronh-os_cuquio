...
<script type="text/javascript">
  //Funcion para cargar el formulario de liquidacion especifico
    function cambia_pagina_boleto(){
      ...
      var url="model/liquidacion/"+target+"/liq_paqueteria_taq_"+pagina+"_op_rl.php"
      $.ajax({
        type: "POST",
        url:url,
        data:{dato:dato},
        beforeSend: function(){
          $("#respuesta_pagina_paqueteria").html("<div class='spinner-border'></div>");
        },
        success: function(datos){
          $('#respuesta_pagina_paqueteria').html(datos);
        }
      });
    }
...
<div class="card">
  ...
  <div class="card-footer">  
    <div id="respuesta_pagina_paqueteria"></div>
  </div>
</div>