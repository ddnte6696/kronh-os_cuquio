...
<script type="text/javascript">
  //Funcion para cargar el formulario de liquidacion especifico
    function total_talonario_taquilla(){
      ...
      var url="model/liquidacion/update/liq_paq_tal_taq_op_rl.php"
      $.ajax({
        type: "POST",
        url:url,
        data:{
...
<div class="card">
  <div class="card-header"><h5>PAQUETERIAS MANUALES DE TAQUILLA</h5></div>
  <div class="card-body">
    <div class="input-group mb-3 input-group-sm">
      <div class="input-group-prepend">
        <span class="input-group-text"><strong>IMPORTE TOTAL</strong></span>
      </div>
      <input type='number' min="0" step="0.01" name='importe_taquilla' id='importe_taquilla' class='form-control' placeholder="Introdusca el importe total de los paquetes de talonario de taquilla" required=''/>
    </div>
