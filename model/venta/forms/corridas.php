...
<script type="text/javascript">
  $(document).ready(mostrar_corridas());
  //window.onload(mostrar_corridas());
</script>
...
<script>
  function mostrar_corridas(){
    $.ajax({
      type: "POST",
      url: "model/venta/queries/corridas_taquilla.php",
  ...
  //Funcion para asignacion de unidad y operador a la corrida
    function asignar_datos(){
      $.ajax({
        type: "POST",
        url: "model/venta/update/asignar_datos.php",
  ...
  //Funcion para cambiar el estado
    function cambiar_estado(){
      $.ajax({
        type: "POST",
        url: "model/venta/update/cambiar_estado.php",
...
<?php
  include_once A_MODEL.'venta/modal/asignar_datos.php';
  include_once A_MODEL.'venta/modal/cambiar_estado.php';
?>