...
?>
<div class="card">
  <div class="card-header"><h5>UNIDADES INHABILITADAS</h5></div>
  <div class="card-body">
            ...
            while ($tabla=$query->fetch(PDO::FETCH_ASSOC)) {
              ...
              echo "
                <tr>
                  ...
                  <td>$motivo</td>
                  <td>
                    <a onclick=\"habilitar_modal($dato)\" class=\"btn btn-success\" data-toggle=\"tooltip\" title=\"Editar este colaborador\">
