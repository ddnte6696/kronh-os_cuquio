...
?>
<div class="card">
  <div class="card-header"><h5>UNIDADES ELIMINADAS</h5></div>
  <div class="card-body">
            ...
            while ($tabla=$query->fetch(PDO::FETCH_ASSOC)) {
              ...
              echo "
                <tr>
                  ...
                  <td>$division</td>
                  <td>
                    <a onclick=\"reactivar_modal($dato)\" class=\"btn btn-success\" data-toggle=\"tooltip\" title=\"Editar este colaborador\">
