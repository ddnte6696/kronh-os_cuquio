<?php
  ...
  //Obtengo los datos enviados por el formulario
    $referencia=campo_limpiado($_POST['ref']);
  //
?>
<div class="card text-center">
  <div class="card-text">
    <a class="btn btn-block btn-primary" href="print_files/liquidacion_rl.php?report=<?php echo campo_limpiado($fecha,1); ?> ?>" target='_blank'>DESCARGAR HOJA DE LIQUIDACION</a>
  </div>
  <div class="card-header">
    <h5>OMNIBUS YAHUALICA GUADALAJARA S.A. DE C.V.</h5>
    <h5>REPORTE DE LIQUIDACION DEL DIA <?php echo campo_limpiado(transforma_fecha($fecha,1," DE "),0,1); ?></h5>
  </div>
  <div class="card-body">
    <div class="row">
      <!-- TABLA DE OPERADOR -->
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <table class="table table-bordered table-sm text-sm table-striped">
                <thead>
                  <tr>
                    <th>UNIDAD</th>
                    <th>OPERADOR</th>
                ...
                <tbody>
                  <?php
                    ...
                    echo "
                      <tr>
                        <td colspan='2'><strong>TOTAL DE LIQUIDACION</strong></td>
       ...
       <!-- TABLA DE  COMISIONES -->
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header"><h6>COMISIONES POR OPERADOR</h6></div>
            <div class="card-body">
              <table class="table table-bordered table-sm text-sm table-striped">
                <thead>
                  <th>ABORDO</th>
